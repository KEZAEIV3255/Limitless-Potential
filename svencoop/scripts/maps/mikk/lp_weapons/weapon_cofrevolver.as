...
class Special38 : ScriptBasePlayerAmmoEntity, ammo_base
{
	...
	{
		return CommonAddAmmo( pOther, CoFREVOLVER::REVOLVER_MAX_CLIP, CoFREVOLVER::REVOLVER_MAX_CARRY, "357" );
	}
}
...
void RegisterCoFREVOLVER()
{
	...
	g_ItemRegistry.RegisterWeapon( CoFREVOLVERName(), "cof/revolver", "357", "", CoFREVOLVERAmmoName() );
}