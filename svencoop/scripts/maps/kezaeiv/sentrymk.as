...
namespace sentrymk
{
    ...
    */
    ...
    void MapInit()
    {
        g_CustomEntityFuncs.RegisterCustomEntity( "sentrymk::CSentryMK2", "monster_sentry_mk2" );
        g_CustomEntityFuncs.RegisterCustomEntity( "sentrymk::CSentryTongue", "sentry_tongue" );
